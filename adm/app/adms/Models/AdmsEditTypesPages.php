...
class AdmsEditTypesPages
{
    ...
    private function edit(): void
    {
        ...
        if ($upTypesPages->getResult()) {
            $_SESSION['msg'] = "<p class='alert-success'>Tipo de páginas editado com sucesso!</p>";
            $this->result = true;
        } else {
            $_SESSION['msg'] = "<p class='alert-danger'>Erro: Tipo de páginas não editado com sucesso #!</p>";
            $this->result = false;
        }
    }
