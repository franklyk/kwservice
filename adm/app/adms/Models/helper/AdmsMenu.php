    ...
    public function itemMenu(): array|null|bool
    {
        ...
        $listMenu->fullRead(
            "SELECT lev_pag.id AS id_lev_pag, lev_pag.dropdown, lev_pag.adms_page_id,
                        ...
                        itm_men.id AS id_itm_men, itm_men.name name_itm_men, itm_men.icon icon_itm_men, sit.id sit_id
                        ...
                        INNER JOIN adms_sits_pgs AS sit ON sit.id=pag.adms_sits_pgs_id
