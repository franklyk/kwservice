...
<div class="wrapper">
    <div class="row">
        <div class="top-list">
            ...
            <div class="top-list-right">
                ...
                if (isset($valorForm['id'])) {
                    echo "<a href='" . URLADM . "view-access_levels/index/" . $valorForm['id'] . "' class='btn-primary'>Visualizar</a><br><br>";
                }
                ?>
            </div>
        </div>
        ...
        <div class="content-adm">
            <form method="POST" action="" id="form-access_levels" class="form-adm">
                <?php
                $id = "";
                if (isset($valorForm['id'])) {
                    $id = $valorForm['id'];
