...
<div class="wrapper">
    <div class="row">
        ...
        <div class="content-adm">
            <form method="POST" action="" id="form-sit-pages" class="form-adm">
                <div class="row-input">
                    <div class="column">
                        <?php
                        $name = "";
                ...
                <button type="submit" name="SendAddSitPages"  class="btn btn-success" value="Cadastrar">Cadastrar</button>
