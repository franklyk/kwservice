...
<div class="wrapper">
    <div class="row">
        <div class="top-list">
            <span class="title-content">Listar Permissões do Nível de Acesso <?php echo $this->data['viewAccessLevels'][0]['name']; ?></span>
            <div class="top-list-right">
                <?php
                echo "<a href='" .URLADM . "list-permission/index' class='btn-info'>Listar Nóvel de Acesso</a>";
                ?>
            </div>
        </div>
